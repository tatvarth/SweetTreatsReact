...
/***/ function(module, exports, __webpack_require__) {
	...
	var Order = __webpack_require__(220);
	var About = __webpack_require__(221);
	var Testimonials = __webpack_require__(222);
	var Contact = __webpack_require__(223);
	...
	ReactDOM.render(React.createElement(
	  ...
	  React.createElement(
	    ...
	    React.createElement(Route, { path: '/testimonials', component: Testimonials }),
	...
	var Nav = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      'div',
	      null,
	      React.createElement('div', { style: divHeaderCss }),
	      React.createElement(
	        'div',
	        { style: divCss },
	        React.createElement('div', { style: logoCss }),
	        React.createElement(
	          'div',
	          { style: menuElementDivCss },
	          React.createElement(
	            IndexLink,
	            { to: '/', activeClassName: 'active', activeStyle: { color: 'black', fontWeight: 'bold' }, style: menuElementCss },
	            'Menu'
	          ),
	          React.createElement(
	            IndexLink,
	            { to: '/gallery', activeStyle: { color: 'black', fontWeight: 'bold' }, style: menuElementCss, activeClassName: 'active' },
	            'Gallery'
	          ),
	          React.createElement(
	            IndexLink,
	            { to: '/order', activeStyle: { color: 'black', fontWeight: 'bold' }, style: menuElementCss, activeClassName: 'active' },
	            'Order'
	          ),
	          React.createElement(
	            IndexLink,
	            { to: '/about', activeStyle: { color: 'black', fontWeight: 'bold' }, style: menuElementCss, activeClassName: 'active' },
	            'About'
	          ),
	          React.createElement(
	            IndexLink,
	            { to: '/testimonials', activeStyle: { color: 'black', fontWeight: 'bold' }, style: menuElementCss, activeClassName: 'active' },
	            'Testimonials'
	          ),
	          React.createElement(
	            IndexLink,
	            { to: '/contact', activeStyle: { color: 'black', fontWeight: 'bold' }, style: menuElementCss, activeClassName: 'active' },
	            'Contact'
	          )
	        )
	      )
